...
LOG_CHANNELS_DB = "/etc/secrets/log_channels.json"
MODELS_DB = "/etc/secrets/models.json"
THRESHOLDS_DB = "/etc/secrets/thresholds.json"
USER_MESSAGES_DB = "/etc/secrets/user_messages.json"
