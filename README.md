Описание кода
Код представляет собой бота для Telegram, написанного с использованием библиотеки aiogram. Он включает в себя управление настройками чата, обработку сообщений и команд, а также взаимодействие с базами данных для хранения различных данных.

Основные функции
Загрузка и сохранение данных:

Функции load_data и save_data используются для работы с JSON файлами, которые хранят различные настройки и данные бота.
Управление чатами:
...
Код использует библиотеку aiogram для работы с Telegram API.
Бот должен быть добавлен в группу, и у него должны быть соответствующие права для выполнения всех команд.
